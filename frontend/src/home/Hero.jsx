...
export default function Hero() {
  const { blogs } = useAuth();
  // console.log("hero section ka blog", blogs);

  return (
    <div className=" container mx-auto grid mt-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 md:px-32 gap-4 p-6">
